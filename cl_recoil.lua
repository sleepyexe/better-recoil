...
local recoils = {
	...
	[584646201] = 0.03, -- AP PISTOL
	[2578377531] = 0.6, -- PISTOL .50
	[324215364] = 0.03, -- MICRO SMG
	[736523883] = 0.1, -- SMG
...
AddEventHandler('CEventGunShot', function (witnesses, ped, coords)
	...
	if recoils[cache.weapon] and recoils[cache.weapon] ~= 0 then
		tv = 0
